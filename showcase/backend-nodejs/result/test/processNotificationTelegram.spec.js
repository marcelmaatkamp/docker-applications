...
// actual testing to see if the telegram notification works is not performed
describe("Test ProcessNotificationTelegram", function () {
    it("should process the telegram notification", function (done) {
