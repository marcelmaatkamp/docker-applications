...
var page = {
	...
	sensors: new model.SensorCollection(),
	collectionView: null,
	sensor: null,
	modelView: null,
	isInitialized: false,
	...
	init: function() {
		...
		$('#filter').change(function(obj) {
			...
			page.fetchSensors(page.fetchParams);
		});
		...
		this.collectionView.on('rendered',function(){
			...
			$('table.collection tbody tr').click(function(e) {
				e.preventDefault();
				var m = page.sensors.get(this.id);
		...
		if (model.longPollDuration > 0)	{
			setInterval(function () {
				...
				if (!page.dialogIsOpen)	{
					page.fetchSensors(page.fetchParams,true);
				}
	 ...
	 */
	fetchSensors: function(params, hideLoader) {
		...
		page.sensors.fetch({
			...
			success: function() {
				...
				if (page.sensors.collectionHasChanged) {
	...
	updateModel: function() {
		...
		page.sensor.save({
			...
			success: function(){
				...
				if (isNew) { page.sensors.add(page.sensor) }
