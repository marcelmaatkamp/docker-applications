<?php
	$this->assign('title','SHOWCASE | AlarmNotificaties');
	$this->assign('nav','alarmnotificaties');

	$this->display('_Header.tpl.php');
?>

<script type="text/javascript">
	$LAB.script("scripts/app/alarmnotificaties.js").wait(function(){
...
<h1>
	<i class="icon-th-list"></i> AlarmNotificaties
	...
	<script type="text/template" id="alarmNotificatieCollectionTemplate">
...
-->
	...
	<script type="text/template" id="alarmNotificatieModelTemplate">
		...
		<form id="deleteAlarmNotificatieButtonContainer" class="form-horizontal" onsubmit="return false;">
			<fieldset>
				<div class="control-group">
					<label class="control-label"></label>
					<div class="controls">
						<button id="deleteAlarmNotificatieButton" class="btn btn-mini btn-danger"><i class="icon-trash icon-white"></i> Delete AlarmNotificatie</button>
						<span id="confirmDeleteAlarmNotificatieContainer" class="hide">
							<button id="cancelDeleteAlarmNotificatieButton" class="btn btn-mini">Cancel</button>
							<button id="confirmDeleteAlarmNotificatieButton" class="btn btn-mini btn-danger">Confirm</button>
						</span>
					</div>
				</div>
			</fieldset>
	...
	<!-- modal edit dialog -->
	<div class="modal hide fade" id="alarmNotificatieDetailDialog">
		<div class="modal-header">
			<a class="close" data-dismiss="modal">&times;</a>
			<h3>
				<i class="icon-edit"></i> Edit AlarmNotificatie
				<span id="modelLoader" class="loader progress progress-striped active"><span class="bar"></span></span>
			</h3>
		</div>
		<div class="modal-body">
			<div id="modelAlert"></div>
			<div id="alarmNotificatieModelContainer"></div>
		</div>
		<div class="modal-footer">
			<button class="btn" data-dismiss="modal" >Cancel</button>
			<button id="saveAlarmNotificatieButton" class="btn btn-primary">Save Changes</button>
		</div>
	</div>

	<div id="collectionAlert"></div>
	
	<div id="alarmNotificatieCollectionContainer" class="collectionContainer">
	</div>

	<p id="newButtonContainer" class="buttonContainer">
		<button id="newAlarmNotificatieButton" class="btn btn-primary">Add AlarmNotificatie</button>
	</p>
