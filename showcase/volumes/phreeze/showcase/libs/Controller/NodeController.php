...
class NodeController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($page != '')
			{
				...
				$output->totalResults = $nodes->TotalResults;
				$output->totalPages = $nodes->TotalPages;
				$output->pageSize = $nodes->PageSize;
				$output->currentPage = $nodes->CurrentPage;
			}
			else
			{
				// return all results
	...
	/**
	 * API Method retrieves a single Node record and render as JSON
	 */
	public function Read()
	{
		try
		{
			$pk = $this->GetRouter()->GetUrlParam('devEui');
			$node = $this->Phreezer->Get('Node',$pk);
			$this->RenderJSON($node, $this->JSONPCallback(), true, $this->SimpleObjectParams());
		}
		catch (Exception $ex)
		{
			$this->RenderExceptionJSON($ex);
	...
	/**
	 * API Method inserts a new Node record and render response as JSON
	 */
	...
	/**
	 * API Method updates an existing Node record and render response as JSON
	 */
	...
	/**
	 * API Method deletes an existing Node record and render response as JSON
	 */
