...
require_once("DAO/Alarm_RegelCriteriaDAO.php");

/**
 * The Alarm_RegelCriteria class extends Alarm_RegelDAOCriteria and is used
 ...
 * @version 1.0
 */
class Alarm_RegelCriteria extends Alarm_RegelCriteriaDAO
{
