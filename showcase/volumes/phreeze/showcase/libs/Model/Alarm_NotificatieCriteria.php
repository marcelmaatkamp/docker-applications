...
require_once("DAO/Alarm_NotificatieCriteriaDAO.php");

/**
 * The Alarm_NotificatieCriteria class extends Alarm_NotificatieDAOCriteria and is used
 ...
 * @version 1.0
 */
class Alarm_NotificatieCriteria extends Alarm_NotificatieCriteriaDAO
{
