...
require_once("DAO/ObservationCriteriaDAO.php");

/**
 * The ObservationCriteria class extends ObservationDAOCriteria and is used
 ...
 * @version 1.0
 */
class ObservationCriteria extends ObservationCriteriaDAO
{
