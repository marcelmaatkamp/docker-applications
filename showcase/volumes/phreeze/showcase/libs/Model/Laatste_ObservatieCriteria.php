...
require_once("DAO/Laatste_ObservatieCriteriaDAO.php");

/**
 * The Laatste_ObservatieCriteria class extends Laatste_ObservatieDAOCriteria and is used
 ...
 * @version 1.0
 */
class Laatste_ObservatieCriteria extends Laatste_ObservatieCriteriaDAO
{
