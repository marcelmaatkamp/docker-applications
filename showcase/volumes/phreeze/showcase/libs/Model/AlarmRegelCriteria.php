...
require_once("DAO/AlarmRegelCriteriaDAO.php");

/**
 * The AlarmRegelCriteria class extends AlarmRegelDAOCriteria and is used
 ...
 * @version 1.0
 */
class AlarmRegelCriteria extends AlarmRegelCriteriaDAO
{
