...
/**
 * Alarm_NotificatieMap is a static class with functions used to get FieldMap and KeyMap information that
 * is used by Phreeze to map the Alarm_NotificatieDAO to the alarm_notificatie datastore.
 *
 ...
 * @version 1.0
 */
class Alarm_NotificatieMap implements IDaoMap, IDaoMap2
{
