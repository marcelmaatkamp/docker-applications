...
require_once("DAO/NodeThresholdCriteriaDAO.php");

/**
 * The NodeThresholdCriteria class extends NodeThresholdDAOCriteria and is used
 ...
 * @version 1.0
 */
class NodeThresholdCriteria extends NodeThresholdCriteriaDAO
{
