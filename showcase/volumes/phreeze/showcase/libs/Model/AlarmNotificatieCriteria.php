...
require_once("DAO/AlarmNotificatieCriteriaDAO.php");

/**
 * The AlarmNotificatieCriteria class extends AlarmNotificatieDAOCriteria and is used
 ...
 * @version 1.0
 */
class AlarmNotificatieCriteria extends AlarmNotificatieCriteriaDAO
{
