...
<html>
    ...
    <body>
        ...
        <div id="show-sensor" class="content scaffold-show" role="main">
            ...
            <f:display bean="sensor" />
            <g:form resource="${this.sensor}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.sensor}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
