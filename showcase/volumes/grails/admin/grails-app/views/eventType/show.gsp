...
<html>
    ...
    <body>
        ...
        <div id="show-eventType" class="content scaffold-show" role="main">
            ...
            <f:display bean="eventType" />
            <g:form resource="${this.eventType}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.eventType}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
